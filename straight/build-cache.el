...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2021-10-10 12:09:25" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2021-10-10 12:09:25" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2021-10-10 12:09:25" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2021-10-10 12:09:25" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2021-10-10 12:09:25" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2021-10-10 12:09:25" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "bespoke-themes" ("2021-10-10 12:09:26" ("emacs") (:host github :repo "mclear-tools/bespoke-themes" :branch "main" :package "bespoke-themes" :type git :local-repo "bespoke-themes"))))
...
(fn &optional PACKAGE)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "straight" '("straight-"))) (defvar straight-x-pinned-packages nil "List of pinned packages.") (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "straight-x" '("straight-x-"))) (provide 'straight-autoloads)) "bespoke-themes" ((bespoke-themes bespoke-themes-autoloads bespoke-theme bespoke-modeline) (autoload 'bespoke-themes-visual-bell-fn "bespoke-modeline" "Blink the mode-line red briefly. Set `ring-bell-function' to this to use it." nil nil) (autoload 'bespoke-themes-visual-bell-config "bespoke-modeline" "Enable flashing the mode-line on error." nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bespoke-modeline" '("bespoke" "buffer-menu-mode-header-line" "shorten-directory" "vc-project-branch"))) (when (and (boundp 'custom-theme-load-path) load-file-name) (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bespoke-theme" '("--l/d" "bespoke"))) (autoload 'bespoke/toggle-theme "bespoke-themes" "Toggle between dark and light variants" t nil) (autoload 'bespoke/light-theme "bespoke-themes" "Set light variant of bespoke-theme" t nil) (autoload 'bespoke/dark-theme "bespoke-themes" "Set dark variant of bespoke-theme" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bespoke-themes" '("bespoke-"))) (provide 'bespoke-themes-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 11 "melpa" nil "gnu-elpa-mirror" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "bespoke-themes" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "bespoke-themes" nil)) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "emacsmirror-mirror" nil "straight" nil "bespoke-themes" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "emacsmirror-mirror" nil "straight" nil "bespoke-themes" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "bespoke-themes" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "el-get" "emacsmirror-mirror" "straight" "emacs" "bespoke-themes")
